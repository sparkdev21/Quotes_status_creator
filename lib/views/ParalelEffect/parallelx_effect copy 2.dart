...
// final parallexDataProvide = FutureProvider<List<Location>>((ref) async {
...
//       final date = Location(
//           name: value.items![i].title!, place: "place", imageUrl: imagesx);
//       locs.add(date);
//       ref.read(todosProvider.notifier).addTodo(date);
...
//                 final myLocs = ref.watch(parallexDataProvide);
//                 // print("locbuild:${myLocs.length}");
//                 myLocs.when(
//                     loading: () =>
//                         Center(child: const CircularProgressIndicator()),
//                     error: (error, stack) =>
//                         Center(child: const Text('Oopsies')),
//                     data: (datas) {
//                       datas = mydata;
//                       for (final location in mydata)
//                         LocationListItem(
